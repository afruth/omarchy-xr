...
normal without changing the workspace bend. A continuous zoom gesture keeps that
first look point. With no look hit, zoom uses the selected monitor center, then
the workspace. Ctrl+Up returns to the full workspace view.
